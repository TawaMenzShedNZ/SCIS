 ...
 *  Program Name: machine_box_WWN_Low
...
* 5.3.1 - 22 Jun 2024 - Relay signal for activation set to LOW
...
// We start by connecting to a WiFi network
  ...
  Serial.println();
  Serial.println("Version: WWN_LOw:");
  Serial.println();
...
void loop() {
  ...
  if (millis()-readerMarker > 30000){
    Serial.println("Forcing reader reset");
